...
- (void)layoutSubviews {
    ...
    /*
     I've reviewed your comments, the only task that I've seen a query on is relating to switching job types.
     
     If a user is default "Maintenance" and does a job then switches to "Service", the previous jobs if they are opened switch to the service header.
     
     A job should be recorded by it's job type and remember it's job type.
     
     Greg
     
     The client is still having troubles with entering "office" jobs - they are being removed from the system after entering for some reason.
